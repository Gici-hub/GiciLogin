...
function countdown() {
    // Waktu tujuan (pukul 12:00 WIB hari ini)
    const targetTime = new Date();
    targetTime.setHours(12, 0, 0, 0); // Set pukul 12:00 WIB
    ...
    const interval = setInterval(() => {
        ...
        if (timeDifference <= 0) {
            ...
            document.getElementById('countdownTime').innerText = `${hours.toString().padStart(2, '0')}:${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')} WIB`;
        }
